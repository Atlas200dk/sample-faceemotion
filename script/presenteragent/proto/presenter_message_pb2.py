...
_PRESENTIMAGEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='point_list', full_name='ascend.presenter.proto.PresentImageRequest.point_list', index=5,
...
_PRESENTIMAGEREQUEST.fields_by_name['point_list'].message_type = _COORDINATE
