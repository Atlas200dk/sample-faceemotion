...
3.  将原始网络模型转换为适配昇腾AI处理器的模型，模型转换有Mind Studio工具转换和命令行转换两种方式。
    -   通过Mind Studio工具进行模型转换。
        ...
        2.  在弹出的**Model** **Conversion**操作界面中，进行模型转换配置，如[图 face\_detection模型转换配置](zh-cn_topic_0203223294.md#fig58411932131319)所示。
            ...
            **图 1**  face\_detection模型转换配置<a name="zh-cn_topic_0203223294_fig206931026131712"></a>  
            

            ![](images/models_facedetection1.png)
        ...
        3.  单击**Next**，进入Nodes配置界面。
            ...
            **图 2**  Nodes配置示例<a name="zh-cn_topic_0203223294_fig3754173017185"></a>  
            

            ![](images/model_facedetection2.png)
        ...
        5.  单击**Next**，进入AIPP配置界面。需要将**Input Image Size\[W\]\[H\]**分别修改为384,304， 此处需要做128\*16对齐。需要将**Model Image Format**修改为BGR888\_U8。其他使用默认值。如[图 AIPP配置](#zh-cn_topic_0203223294_fig1682055223010)所示
            ...
            **图 3**  AIPP配置<a name="zh-cn_topic_0203223294_fig1682055223010"></a>  
            ![](images/AIPP.png)
        ...
        6.  单击**Finish**，开始进行模型转换。
            ...
            **图 4**  模型转换错误<a name="zh-cn_topic_0203223294_fig2865313121718"></a>  
            

            ![](images/model_facedetection_coversionfailed.png)
            ...
            模型转换成功后，后缀为.om的离线模型存放地址为_$HOME/modelzoo/face\_detection/device_。
        7.  FaceEmotion的模型转换和人脸检测模型转换类似，具体AIPP配置如下。
            ...
            **图 6**  FaceEmotion AIPP配置<a name="zh-cn_topic_0203223294_fig2865313121718"></a>  
...
2.  <a name="zh-cn_topic_0182554631_li08019112542"></a>执行部署脚本，进行工程环境准备，包括ascenddk公共库的编译与部署、Presenter Server服务器的配置等操作，其中Presenter Server用于接收Application发送过来的数据并通过浏览器进行结果展示。
    ...
    **图 7**  工程部署示意图<a name="zh-cn_topic_0182554631_fig184321447181017"></a>  
   ![image](images/%E5%B7%A5%E7%A8%8B%E9%83%A8%E7%BD%B2%E7%A4%BA%E6%84%8F%E5%9B%BE.png)
...
3.  启动Presenter Server。
    ...
    **图 8**  Presenter Server进程启动<a name="zh-cn_topic_0182554631_fig69531305324"></a>  
    ![images](images/Presenter-Server%E8%BF%9B%E7%A8%8B%E5%90%AF%E5%8A%A8.png)
    ...
    **图 9**  主页显示<a name="zh-cn_topic_0182554631_fig64391558352"></a>  
    ![images](images/Presenter-Server%E8%BF%9B%E7%A8%8B%E5%90%AF%E5%8A%A8.png)

    Presenter Server、Mind Studio与Atlas 200 DK之间通信使用的IP地址示例如下图所示：

    **图 10**  IP地址示例<a name="zh-cn_topic_0182554631_fig1881532172010"></a>  
    ![images](images/IP%E5%9C%B0%E5%9D%80%E7%A4%BA%E4%BE%8B.png)
...
2.  使用启动Presenter Server服务时提示的URL登录 Presenter Server 网站，仅支持Chrome浏览器。
    ...
    **图 11**  Presenter Server界面<a name="zh-cn_topic_0182554631_fig1189774382115"></a>  
